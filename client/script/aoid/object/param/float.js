function AoidParamFloat(master, id, parent_id, kind, description_id, minv, maxv, precision) {
	this.master = master;
	this.id = id;
		...
		if(supported){
			...
			switch(command){
				...
				case CMD_AOID_GET_NVRAM_VALUE:
					new_item = new AoidCommandGetFloat(this, command, this.precision);
					break;
				case CMD_AOID_SET_NVRAM_VALUE:
					new_item = new AoidCommandSetFloat(this, command, this.minv, this.maxv, this.precision);
					break;
			}
